...
if (!process.env.NOMAD_AZURE_BLOB_CONNECTION_STRING) {
  throw new Error('NOMAD_AZURE_BLOB_CONNECTION_STRING environment variable is not set');
}

const AZURE_STORAGE_CONNECTION_STRING = process.env.NOMAD_AZURE_BLOB_CONNECTION_STRING;
