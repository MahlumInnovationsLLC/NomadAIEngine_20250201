...
// Export Building System Functions
...
export async function addBuildingSystem(systemData: BuildingSystemInput) {
  try {
    const newSystem = {
...
export async function updateBuildingSystem(id: number, updates: Partial<typeof buildingSystems.$inferInsert>) {
  try {
...
// Update the addBuildingSystem function with proper typing
interface BuildingSystemInput {
  name: string;
  type: string;
  location: string;
    ...
    try {
      ...
      app.post("/api/facility/building-systems", async (req, res) => {
        try {
          ...
          const systemData = req.body as BuildingSystemInput;
...
// Update theaddBuildingSystem function
export async function addBuildingSystem(systemData: BuildingSystemInput) {
  try {
    const newSystem = {
      id: uuidv4(),
...
export async function updateBuildingSystem(id: string, updates: Partial<typeof buildingSystems>) {
  try {
...
export async function updateBuildingSystem(id: number, updates: Partial<typeof buildingSystems>) {
  try {
    const [updatedSystem] = await db
      .update(buildingSystems)
      .set({
