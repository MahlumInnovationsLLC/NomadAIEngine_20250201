...
import { SupplierPerformanceHistory } from "./performance/SupplierPerformanceHistory";
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="scorecard" className="space-y-4">
          <SupplierPerformanceHistory supplierId={supplierId} />
        </TabsContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 border rounded-lg">
                  <FontAwesomeIcon icon="user-circle" className="h-10 w-10 text-muted-foreground" />
                  <div className="flex-1">
                    <div className="font-medium">{supplier.contact.name}</div>
                    <div className="text-sm text-muted-foreground">Primary Contact</div>
                    <div className="mt-2 space-y-1">
                      <div className="text-sm">
                        <FontAwesomeIcon icon="envelope" className="h-4 w-4 mr-2" />
                        {supplier.contact.email}
                      </div>
                      <div className="text-sm">
                        <FontAwesomeIcon icon="phone" className="h-4 w-4 mr-2" />
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="ghost" size="sm">
                      <FontAwesomeIcon icon="phone" className="h-4 w-4" />
                    </Button>
                    <Button variant="ghost" size="sm">
                      <FontAwesomeIcon icon="message" className="h-4 w-4" />
                    </Button>
                  </div>
                </div>
              </div>
